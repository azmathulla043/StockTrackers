package com.tech.stockspickertracker.Helper;
...
public class AlertReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ticker.getHighThershold() != null && ticker.getLowThreshold() != null) {
            data = new Data.Builder()
                    ...
                    .putDouble(StockWorker.STOCK_HIGH_THRESHOLD, ticker.getHighThershold())
                    .putInt(StockWorker.STOCK_ID, ticker.getId())
                    .build();
        }
        else if (ticker.getHighThershold() != null) {
            data = new Data.Builder()
                    .putString(StockWorker.STOCK_TICKER, ticker.getSymbol())
                    .putString(StockWorker.STOCK_NAME, stockName)
                    .putDouble(StockWorker.STOCK_HIGH_THRESHOLD, ticker.getHighThershold())
