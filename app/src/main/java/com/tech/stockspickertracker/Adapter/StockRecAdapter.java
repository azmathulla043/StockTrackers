...
import com.tech.stockspickertracker.UI.StockDetailActivity;
...
public class StockRecAdapter extends RecyclerView.Adapter<StockRecAdapter.ViewHolder> {
    ...
    private ArrayList<TickerModel> tickers = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Double highThreshold = tickers.get(position).getLowThreshold();
