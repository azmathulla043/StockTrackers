package com.tech.stockspickertracker.Network;
...
public class APIService {
    ...
    public Observable<Cursor> getSymbols(String ticker) {
        ...
        final Request request = new Request.Builder().url("https://www.alphavantage.co/query?function=SYMBOL_SEARCH&keywords=" + ticker + "&apikey=C8W0MVNORQHKGOVK").build();
    ...
    // Add database in the background
